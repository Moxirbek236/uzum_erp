...
let ReviewsController = class ReviewsController {
    ...
    async getReviews(shopId, page = '0', size = '10', filter, search) {
        const parsedShopId = shopId ? parseInt(shopId, 10) : undefined;
        return this.reviewsService.getReviews(parsedShopId, parseInt(page, 10), parseInt(size, 10), filter, search);
    }
    async generateAiReply(id) {
...
], ReviewsController.prototype, "getUnreadCount", null);
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)('shopId')),
...
__decorate([
    (0, common_1.Post)(':id/generate-ai-reply'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ReviewsController.prototype, "generateAiReply", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ReviewsController.prototype, "markAsRead", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ReviewsController.prototype, "togglePin", null);
